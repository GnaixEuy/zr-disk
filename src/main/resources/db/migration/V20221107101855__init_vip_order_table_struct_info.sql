CREATE TABLE `disk`.`vip_order`  (
     `order_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '订单ID主键',
     ...
     `order_trade_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '订单支付宝交易凭证号',
     `order_created_date` datetime(6) NOT NULL COMMENT '订单创建时间',
     `order_pay_date` datetime(6) NULL DEFAULT NULL COMMENT '订单支付时间',
