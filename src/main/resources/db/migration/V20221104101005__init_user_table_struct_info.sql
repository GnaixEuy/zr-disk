...
(
    ...
    `head_img_id`       varchar(32)  NULL COMMENT '头像文件关联',
    ...
    `drive_size`        double       NOT NULL COMMENT '用户存储空间'   DEFAULT 10737418240,
    `drive_used`        double       NOT NULL COMMENT '用户已使用空间' DEFAULT 0,
